...
int hl_drv_aw2016a_test_init(int argc, char* argv[])
{
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_GET_CHIP_ID, &chip_id, sizeof(chip_id));
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_WORK_MODE, &work_mode, sizeof(work_mode));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_SYNC_CONTROL_MODE, &flag, sizeof(flag));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_GLOBAL_MAX_OUTPUT_CURRENT, &work_mode,
                              sizeof(work_mode));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_OPEN_LED_CHANNEL, &led_chan, sizeof(led_chan));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_PATTERN_MODE, &led_chan, sizeof(led_chan));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_BREATH_PARAM, &pattern_param,
    ...
    ret = hl_drv_aw2016a_ctrl(atoi(argv[5]), HL_DRV_AW2016A_SET_LED_LIGHT_EFFECT, &light, sizeof(light));
    if (ret == AW2016A_FUNC_RET_ERR) {
        return AW2016A_FUNC_RET_ERR;
    }
